...
public class CoinSpawner : MonoBehaviour
{
    ...
    private void SpawnCoin(){
        ...
        float y = Mathf.Sin(Mathf.Deg2Rad * (Random.Range(- verticalRange, verticalRange) / 2));
        ...
        currentTarget = Instantiate(prefab, transform.position + spawnPosition, Quaternion.identity);
    ...
    private void OnDrawGizmosSelected() {
        ...
        Gizmos.DrawRay(transform.position, new Vector3(0, Mathf.Sin(Mathf.Deg2Rad * verticalRange / 2), Mathf.Cos(Mathf.Deg2Rad * verticalRange / 2) ) * spawnRadius);
        Gizmos.DrawRay(transform.position, new Vector3(0, Mathf.Sin(Mathf.Deg2Rad * - verticalRange / 2), Mathf.Cos(Mathf.Deg2Rad * - verticalRange / 2) ) * spawnRadius);
